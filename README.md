...
**Phase F4** — Resolution + Claim live. P0 + F1 + F2 + F3 + F4 all GREEN. The full lifecycle is operational on Arbitrum Sepolia: wrap → bet → batch publish → resolveOracle (admin or pre-resolved) → freezePool → claimWinnings (intent recorded; payout transfer arrives in F5) and the parallel refundIfInvalid path. Three resolution adapters (admin commit-reveal, pre-resolved, Chainlink mainnet-ready), commit-reveal MEV mitigation, ClaimVerifier with placeholder TDX measurement (F5 redeploys with real one), and FeeVault are all deployed and verified on Arbiscan. F5 wires TEE handlers and the actual proportional payout math.
...
| Arbitrum Sepolia | `Market.sol` v2 (impl, F4 logic)      | [`0x297Ddb129f87B37e4B28cD1c1c6457ED0c7BB8c4`](https://sepolia.arbiscan.io/address/0x297ddb129f87b37e4b28cd1c1c6457ed0c7bb8c4) ✅                                                                                                                                                                                                                                                                                                                                                                        |
| Arbitrum Sepolia | `MarketRegistry.sol` v2               | [`0xE66B2F638F5dB738243a44F7Aeb1cccc18906dD1`](https://sepolia.arbiscan.io/address/0xe66b2f638f5db738243a44f7aeb1cccc18906dd1) ✅                                                                                                                                                                                                                                                                                                                                                                        |
...
| Arbitrum Sepolia | Market[1] (admin-resolved, +14d)      | [`0x98ae591D6D5f31FC6840d9124e58963cC2EC53f7`](https://sepolia.arbiscan.io/address/0x98ae591d6d5f31fc6840d9124e58963cc2ec53f7) ✅                                                                                                                                                                                                                                                                                                                                                                        |
| Arbitrum Sepolia | Market[2] (pre-resolved YES)          | [`0xeC3b47C7eAaF601a32cdfDe37aA078ebbc1c3297`](https://sepolia.arbiscan.io/address/0xec3b47c7eaaf601a32cdfde37aa078ebbc1c3297) ✅                                                                                                                                                                                                                                                                                                                                                                        |
