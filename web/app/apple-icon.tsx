...
/// Next.js file convention. Generates /apple-icon at 180×180 PNG. Static
/// image (no per-request data), so default runtime is fine — no edge fetch
/// for fonts. The crest is hand-drawn SVG inside the JSX so it renders
